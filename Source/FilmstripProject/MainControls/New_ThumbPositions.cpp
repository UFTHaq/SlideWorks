...
New_ThumbPositions::New_ThumbPositions()
...
void New_ThumbPositions::paint(juce::Graphics& g)
{
    group.paint(g);
}

void New_ThumbPositions::resized()
{
...
void New_ThumbPositions::setupGroupComponent()
{
...
double New_ThumbPositions::getMaxThumbPos() const
{
    return maxThumbPos.getValue();
}

double New_ThumbPositions::rounded_2Digit(double value)
{
