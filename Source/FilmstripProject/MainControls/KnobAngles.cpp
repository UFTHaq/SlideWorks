...
void KnobAngles::paint(juce::Graphics& g)
{
    group.paint(g);
}

void KnobAngles::resized()
{
...
void KnobAngles::mouseDown(const juce::MouseEvent& event)
{
}

void KnobAngles::mouseDoubleClick(const juce::MouseEvent& event)
{
...
void KnobAngles::setupGroupComponent()
{
...
void KnobAngles::setColourGroup()
{
...
void KnobAngles::setupAngleControls()
{
    double interval = 1;
...
void KnobAngles::setColourMinAngle()
{
...
void KnobAngles::setColourMaxAngle()
{
...
double KnobAngles::getMinAngle() const
{
    return minAngle.getValue();
}

double KnobAngles::getMaxAngle() const
{
    return maxAngle.getValue();
}

void KnobAngles::resetCurrentTheme()
{
    setColourGroup();
    setColourMinAngle();
    setColourMaxAngle();
