...
//ControlCanvas::ControlCanvas(New_Canvas& canvas)
...
void ControlCanvas::setupWidthSlider()
{
    ...
    //width.setValue(canvas.getCanvasEdit().getRealCanvasWH().getX());
    width.setValue(300);
    width.onValueChange = [this]()
        {
            //canvas.getCanvasEdit().setRealCanvasWidth(width.getValue());
        };
...
void ControlCanvas::setupHeightSlider()
{
    ...
    //height.setValue(canvas.getCanvasEdit().getRealCanvasWH().getY());
    height.setValue(300);
    height.onValueChange = [this]()
        {
            //canvas.getCanvasEdit().setRealCanvasHeight(height.getValue());
        };
