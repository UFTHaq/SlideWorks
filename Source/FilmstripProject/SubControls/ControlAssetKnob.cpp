...
const int ControlAssetKnob::getAreaHeight() const
{
    return AREA_HEIGHT;
}

double ControlAssetKnob::getAssetVirtualWidthPercentage() const
{
    return width.getValue() / 100;
}

double ControlAssetKnob::getAssetVirtualHeightPercentage() const
{
    return height.getValue() / 100;
}

void ControlAssetKnob::setOriginalAssetRatio(int imageWidth, int imageHeight)
{
    imageRatio = Ratio{
        .w = imageWidth,
        .h = imageHeight
...
void ControlAssetKnob::calculateAssetRealAndVirtualBounds()
{
    {
        //int w{};
        //int h{};
        //if (realCanvas.getWidth() < realCanvas.getHeight())
        //{
        //    w = realCanvas.getWidth();
        //    h = w;

        //    if (imageRatio.w != 0 && imageRatio.h != 0)
        //    {
        //        h = int(w / imageRatio.w * imageRatio.h);
        //    }
        //}
        //else
        //{
        //    h = realCanvas.getHeight();
        //    w = h;

        //    if (imageRatio.w != 0 && imageRatio.h != 0)
        //    {
        //        w = int(h * imageRatio.w / imageRatio.h);
        //    }
        //}
    ...
    //DBG("ASSET KNOB BOUNDS IN REAL CANVAS : " << assetBoundsRealC.toString());
    //DBG("ASSET KNOB BOUNDS IN VIRTUAL CANVAS : " << assetBoundsVirtC.toString());

    if (onVirtBoundsChange)
        onVirtBoundsChange();
}

bool ControlAssetKnob::isAssetCanChangeColor() const
{
    return false;
}
...
void ControlAssetKnob::setupAngleOffsetComponents()
{
...
void ControlAssetKnob::setupRotateComponents()
{
...
void ControlAssetKnob::setupWidthSlider()
{
...
void ControlAssetKnob::setupHeightSlider()
{
...
void ControlAssetKnob::recalibrateAngle()
{
