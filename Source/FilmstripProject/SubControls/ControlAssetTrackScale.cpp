...
const int ControlAssetTrackScale::getAreaHeight() const
{
    return AREA_HEIGHT;
}

double ControlAssetTrackScale::getAssetVirtualWidthPercentage() const
{
    return width.getValue() / 100;
}

double ControlAssetTrackScale::getAssetVirtualHeightPercentage() const
{
...
void ControlAssetTrackScale::calculateAssetRealAndVirtualBounds()
{
    {
...
bool ControlAssetTrackScale::isAssetCanChangeColor() const
{
    return true;
}

juce::Colour ControlAssetTrackScale::getAssetAlphaColor() const
{
    return alphaColor.withAlpha((float)(alpha.getValue() / 100));
}

void ControlAssetTrackScale::setupGroupComponent()
{
...
void ControlAssetTrackScale::setColourGroup()
{
...
void ControlAssetTrackScale::setupAngleOffsetComponents()
{
...
void ControlAssetTrackScale::setupRotateComponents()
{
...
void ControlAssetTrackScale::setupLockRatio()
{
...
void ControlAssetTrackScale::setupWidthSlider()
{
...
void ControlAssetTrackScale::setupHeightSlider()
{
...
void ControlAssetTrackScale::setupColorChooser()
{
...
void ControlAssetTrackScale::showColorChooser()
{
    bool native{ false };
...
void ControlAssetTrackScale::setupAlphaSlider()
{
...
void ControlAssetTrackScale::recalibrateAngle()
{
...
void ControlAssetTrackScale::resetCurrentTheme()
{
    setColourGroup();
}
