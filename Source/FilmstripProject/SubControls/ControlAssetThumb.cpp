...
const int ControlAssetThumb::getAreaHeight() const
{
    return AREA_HEIGHT;
}

double ControlAssetThumb::getAssetVirtualWidthPercentage() const
{
    return width.getValue() / 100;
}

double ControlAssetThumb::getAssetVirtualHeightPercentage() const
{
...
bool ControlAssetThumb::isAssetCanChangeColor() const
{
    return false;
}

void ControlAssetThumb::setupGroupComponent()
{
...
void ControlAssetThumb::setColourGroup()
{
...
void ControlAssetThumb::setupAngleOffsetComponents()
{
...
void ControlAssetThumb::setupRotateComponents()
{
...
void ControlAssetThumb::setupLockRatio()
{
...
void ControlAssetThumb::setupWidthSlider()
{
...
void ControlAssetThumb::setupHeightSlider()
{
...
void ControlAssetThumb::recalibrateAngle()
{
...
void ControlAssetThumb::resetCurrentTheme()
{
    setColourGroup();
}
