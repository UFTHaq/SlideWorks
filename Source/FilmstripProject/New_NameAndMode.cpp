...
New_NameAndMode::New_NameAndMode()
...
void New_NameAndMode::mouseDown(const juce::MouseEvent& event)
{
...
void New_NameAndMode::mouseDoubleClick(const juce::MouseEvent& event)
{
...
void New_NameAndMode::setupNameEditor()
{
...
void New_NameAndMode::setupModeButtons()
{
...
void New_NameAndMode::togglingButtons(juce::TextButton& toActive, juce::TextButton& toDeactive1, juce::TextButton& toDeactive2)
{
...
void New_NameAndMode::setToggling(WorkingMode Workmode)
{
    switch (Workmode)
    {
...
void New_NameAndMode::notifyModeChange()
{
    if (onModeChange)
        onModeChange();
}

WorkingMode New_NameAndMode::getMode() const
{
    return mode;
}

juce::TextEditor& New_NameAndMode::getNameEditor()
{
    return nameEditor;
}

juce::TextButton& New_NameAndMode::getSimulationButton()
{
    return simulationButton;
}

juce::TextButton& New_NameAndMode::getPreviewButton()
{
    return previewButton;
}

juce::TextButton& New_NameAndMode::getEditButton()
{
    return editButton;
}
